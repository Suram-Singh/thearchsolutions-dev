...
(function ($) {
  $.fn.downCount = function (options, callback) {
    var settings = $.extend(
      { date: "04/01/2025 12:00:00", offset: null },
      options
    );
    if (!settings.date) {
    ...
    function countdown() {
      ...
      var target_date = new Date("04/01/2025 12:00:00");
...
$("<div class='pl-row'><span class='pl-row-anim'></span></div>")
  .duplicate(25)
  .appendTo(".ds_dec-grid");
function heroAnim() {
...
$(".loader-wrap").append(
  '<div class="loader-wrap-container fs-wrapper" data-ran="25"></div>'
);
$("<div class='lw-dot'><span class='lw-dot-anim'></span></div>")
  .duplicate(25)
  .appendTo(".loader-wrap-container");
...
function firstload() {
  ...
  setTimeout(function () {
    var b = $(".lw-dot-anim");
    $(a(b).slice(0, $(".loader-wrap-container").data("ran"))).each(function (
      a
    ) {
      var b = $(this);
      setTimeout(function () {
